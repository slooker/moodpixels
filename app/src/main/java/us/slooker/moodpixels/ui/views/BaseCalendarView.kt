...
abstract class BaseCalendarView
    ...
    constructor(
        ...
        protected val todayPaint =
            Paint(Paint.ANTI_ALIAS_FLAG).apply {
                color = Color.parseColor("#FFF9C4")
                style = Paint.Style.FILL
            }

        protected val headerPaint =
            Paint(Paint.ANTI_ALIAS_FLAG).apply {
                color = Color.parseColor("#F5F5F5")
                style = Paint.Style.FILL
            }

        protected val headerTextPaint =
            Paint(Paint.ANTI_ALIAS_FLAG).apply {
