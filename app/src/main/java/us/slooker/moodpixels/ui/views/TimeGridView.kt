...
class TimeGridView
    ...
    constructor(
        ...
        override fun onDraw(canvas: Canvas) {
            ...
            headerTextPaint.textSize = dpToPx(12f) * textScale
            gridPaint.color = if (dark) Color.parseColor("#444444") else Color.parseColor("#E0E0E0")
            todayPaint.color = if (dark) Color.parseColor("#1A1400") else Color.parseColor("#FFF9C4")
            timeTextPaint.color = if (dark) Color.parseColor("#AAAAAA") else Color.parseColor("#888888")
            timeTextPaint.textSize = dpToPx(10f) * textScale
            moodLabelPaint.textSize = dpToPx(9f) * textScale
            ...
            cellPaint.color = if (dark) Color.parseColor("#0D0D0D") else Color.parseColor("#FAFAFA")
