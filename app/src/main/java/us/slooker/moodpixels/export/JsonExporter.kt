...
object JsonExporter {
    ...
    fun buildJson(
        ...
        val root =
            ExportRoot(
                ...
                legend = legend.map { LegendRecord(colorIntToHex(it.colorValue), it.moodName) },
                moodEntries =
                        ...
                        QuestionRecord(
                            ...
                            scheduleDays =
                                if (q.scheduleType == "DAILY") {
                                    ...
                                    dayNames.filterIndexed { i, _ -> q.scheduleDays and (1 shl i) != 0 }
                                },
    ...
    fun buildShareIntent(
        ...
        val json = buildJson(legend, moodEntries, questions, answers)
    ...
    private fun colorIntToHex(color: Int) = String.format("#%02X%02X%02X", Color.red(color), Color.green(color), Color.blue(color))
